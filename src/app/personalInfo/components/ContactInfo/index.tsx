    ...
    <Section id='contacto'>
      <Container>
        ...
        <Group className='mt-5'>
          <GroupItem href={socialNetworks[1].url} target='_blank' rel='noreferre'>
            <GroupIcon>
          ...
          <GroupItem href={socialNetworks[2].url} target='_blank' rel='noreferre'>
            <GroupIcon>
          ...
          <GroupItem href={socialNetworks[3].url} target='_blank' rel='noreferre'>
            <GroupIcon>
